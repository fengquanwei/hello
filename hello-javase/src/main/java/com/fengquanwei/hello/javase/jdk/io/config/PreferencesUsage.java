package com.fengquanwei.hello.javase.jdk.io.config;
...
public class PreferencesUsage {
    public static void main(String[] args) throws BackingStoreException, IOException, InvalidPreferencesFormatException, ClassNotFoundException {
        ...
        Preferences systemNode = systemRoot.node("com.kilogate.hello.java.PreferencesUsage");
        Preferences userNode = userRoot.node("com.kilogate.hello.java.PreferencesUsage");

        Class<?> clazz = Class.forName("com.kilogate.hello.java.PreferencesUsage");
