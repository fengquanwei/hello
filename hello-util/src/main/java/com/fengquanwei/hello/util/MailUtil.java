...
public class MailUtil {
    private static String USERNAME = "xxxxxx@163.com"; // 用户名
    private static String PASSWORD = "xxxxxx"; // 密码
    private static String FROM = "xxxxxx@163.com"; // 发件地址
    ...
    public static void send(String[] recipients, String subject, String html, String[] filepaths) {
        try {
            ...
            String errorMsgFormat = "发送邮件异常，recipients：%s，subject：%s，html：%s，filepaths：%s, exception: %s";
            System.out.println(String.format(errorMsgFormat, Arrays.toString(recipients), subject, html, Arrays.toString(filepaths), e));
        }
    }
    ...
    public static void main(String[] args) {
        MailUtil.send(new String[]{"xxxxxx@163.com"}, "测试邮件", "", new String[]{"/Users/fengquanwei/abc.txt"});
    }
}
