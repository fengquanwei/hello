 ...
 **/
public class ZooKeeperACLUsage {
    public static void main(String[] args) throws IOException, KeeperException, InterruptedException {
        // 使用权限控制创建节点
        ZooKeeper zooKeeperWithAuth = new ZooKeeper("127.0.0.1:2181,127.0.0.1:2182,127.0.0.1:2183/test", 5000, null);
        ...
        // 无权限访问
        try {
            ZooKeeper zooKeeper = new ZooKeeper("127.0.0.1:2181,127.0.0.1:2182,127.0.0.1:2183/test", 5000, null);
